namespace Models
{
    ...
    public partial class TimeSeriesDaily
    {
        ...
        public decimal The4Close { get; set; }
    ...
    public partial class StockResponse
    {
        public static StockResponse FromJson(string json) => JsonConvert.DeserializeObject<StockResponse>(json, Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this StockResponse self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
    }
